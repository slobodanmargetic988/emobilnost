...
@Autowired
    private EmobilnostUserDetailsService emobilnostUserDetailsService;
...
authenticationProvider.setUserDetailsService(emobilnostUserDetailsService);
 ...
 @Bean
 public EmobilnostUserDetailsService emobilnostUserDetailService(){
 return new EmobilnostUserDetailsService();
 }
